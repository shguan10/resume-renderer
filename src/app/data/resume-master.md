...
*   **4 years non-internship professional experience** using C, C++, Python in full software development life cycle with Agile methodologies and Azure DevOps
*   **Strong background in statistics**, deep learning (PyTorch, Keras), and natural language processing

## TECHNICAL SKILLS
*   **Languages:** C/C++, Python, CUDA, TypeScript, JavaScript, Java, HLSL, HTML, CSS
*   **Frameworks & Tools:** PyTorch, TensorFlow, DirectML, DirectX, Tailwind, Vite, Deno
*   **Data & Backend:** Postgres, SQLite, Supabase, Cosmos, Kusto, Azure DevOps

## WORK EXPERIENCE

### **Microsoft, Inc.** | Redmond, WA
**Software Engineer, DirectML Team** | *Aug 2023 – Jan 2025*
...
**Software Engineer, Connectivity Platform Team** | *Feb 2021 – Aug 2023*
...
**Software Engineer Intern, Connectivity Platform Team** | *May 2020 – Aug 2020*
*   Developed a configurable, extendable, and exhaustive test suite in Python for a new smart IoT sensor

**Explore (PM+SWE) Intern, Platform Integrity Team** | *May 2019 – Aug 2019*
...
### **Caterpillar, Inc.**
**Machine Perception Engineer Co-op** | Pittsburgh, PA | *Aug 2018 – May 2019*
...
**Software Engineer Intern** | Peoria, IL | *May 2018 – Aug 2018*
...
---page-break---
## TEACHING EXPERIENCE
**Teaching Assistant: Intermediate Deep Learning (10-417/617)** | CMU | *Aug 2019 – May 2020*
*   Led the efforts to create auto-graded unit tests and a better template for the Backpropagation programming assignment
*   Led recitations on Vector Differentiation for 30 students.

## NOTABLE PROJECTS & RESEARCH

**PerceptionTrainer** | *Jan 2026 – March 2026*
*   Created a gamified skill training web app for artists and musicians.
*   Leveraged AI agents to accelerate the whole software development life cycle, from technical specification, implementation, prototyping, refactoring and debugging.
*   Technologies used: Gemini, Lovable, Codex, Vite, Typescript, Tailwind, PostgreSQL, Supabase, Deno
...
**Dense CNN for Chest Disease Identification** | *April 2018*
*   Achieved better AUROC scores than CheXNet model by incorporating additional features and a skip connection.
*   Won the **Best in Show** award at Hack Auton hackathon.

**Snowflake, the Fridge Management System** | *March 2018*
*   Developed an automatic food inventory system that suggests recipes, tracks expiration dates, and reduces food waste.
*   Used Computer Vision in TensorFlow to identify the food item and update the inventory on the Amazon EC2 server

**Sight2Sound, an Aid to the Blind** | *January 2018*
*   Transformed videos into AM audio by mapping pixels to frequencies using the Hilbert curve to enable users to perceive movement.
*   Enabled users to perceive movement across the camera through listening to the device’s audio

## EDUCATION
**Carnegie Mellon University (CMU)**, GPA: 3.68 | Pittsburgh, PA
